...
loss_type = "huber"
lr_scheduler = "linear"
lr_scheduler_args = ["--warmup_steps=200"]
...
optimizer_type = "AdamW8bit"     # Lebih efisien untuk A100
output_dir = "/app/outputs"
output_name = "last"
...
text_encoder_lr = [ 1.5e-5, 1.5e-5 ]   # Sedikit lebih kecil
